  ...
  const newTask = {
    ...
    main: `
        ...
        <div class="right_side side">
            <button id=${id} class=${this.isDone ? 'donebtn done' : 'donebtn'}><svg width="16" height="12" viewBox="0 0 16 12" fill="black" xmlns="http://www.w3.org/2000/svg">
